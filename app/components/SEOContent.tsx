  ...
  return (
    <div className="content-section">
      ...
      <p>
        ...
        validate, and beautify JSON (JavaScript Object Notation) data. JSON is
        the most widely used data format for APIs, configuration files, and data
      ...
      <ul>
        <li>
          <strong>Format JSON instantly</strong> - Convert minified JSON into
          readable, properly indented format
        </li>
        <li>
          <strong>Validate JSON syntax</strong> - Detect errors with detailed
          error messages showing exactly where the problem is
        </li>
        <li>
          <strong>Minify JSON</strong> - Compress JSON by removing unnecessary
          whitespace for production
        </li>
        <li>
          <strong>Debug API responses</strong> - Quickly understand complex JSON
          structures from API calls
        </li>
        <li>
          <strong>Copy formatted output</strong> - One-click copy to clipboard
          for easy pasting
        </li>
      </ul>
      ...
      <ol>
        ...
        <li>
          Click "Format & Beautify" to format your JSON with proper indentation
        </li>
      ...
      <ul>
        ...
        <li>
          <strong>Learning JSON</strong> - Understand JSON structure and syntax
          better
        </li>
        <li>
          <strong>Code Review</strong> - Present JSON data in a readable format
          for team review
        </li>
      </ul>
      ...
      <div className="features-grid">
        ...
        <div className="feature-card">
          <h4>✓ Validate JSON</h4>
          <p>
            Detect syntax errors with detailed error messages and line numbers.
          </p>
        </div>
        <div className="feature-card">
          <h4>⚡ Minify</h4>
